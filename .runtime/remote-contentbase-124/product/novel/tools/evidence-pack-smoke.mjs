...
const semanticTags = splitList(args.semanticTags || '');
...
const request = {
  ...
  semanticTags: semanticTags.join(','),
...
function assertEvidencePack(pack, options) {
  ...
  if (!/database\.search_chunks|database\.search_documents|semantic_units|DataBase/i.test(providerText)) {
