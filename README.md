...
ContentMRS 是一套全链路中文内容生成系统。它的目标不是"让 AI 帮你写稿"，而是让一个人拥有稳定、可复现、带有个人风格烙印的工业化写作能力。

覆盖体裁：

- 评论性散文（政论、时事评论、历史散文、文化批评）
- 长篇小说（章节连载、世界观维护、角色连续性）
- 视频文案（短视频脚本、长视频解说）
- 历史叙事（沉浸式非虚构、制度考古、地缘分析）
- 短篇虚构（实验性叙事、意识流）

文体信条：

- 判断在动词里，立场在选词里，暴力在精确里
- 事实从 Reality 层来，编不了——数字/人名/机构/时间必须有出处
- 风格从 16 位作者的化用来——鲁迅/三岛由纪夫/内藤湖南/石黑一雄/安德森/白鸟库吉/桑原骘藏/宫崎市定/北一辉/希特勒/墨索里尼/戈培尔/太宰治/坂口安吾/川端康成/夏目漱石。化用其写法，正文中永不提名
- 立场通过选材表达，不通过宣言表达
- 结尾停在硬事实上，不升华、不展望、不回扣开头

工程原则：

- 一个 Writer，写一次，不重写、不循环、不评估链
- 质量来自上下文密度，不来自后处理规则
- Reality 缺失时 fail closed，绝不退化成自由发挥
- 风格材料教"怎么写"，不教"写什么"
- 双模型路由：Claude（判断锋利）写评论，Qwen（文学性强）写叙事

这不是一个通用写作助手。这是一个有立场、有审美、有边界的内容工厂。
