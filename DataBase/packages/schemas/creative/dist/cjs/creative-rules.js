...
exports.CREATIVE_EXECUTABLE_RULES = void 0;
exports.resolveCreativeRuleTaskType = resolveCreativeRuleTaskType;
exports.getCreativeRuleInventory = getCreativeRuleInventory;
exports.runCreativeRules = runCreativeRules;
...
function resolveCreativeRuleTaskType(taskType) {
...
exports.CREATIVE_EXECUTABLE_RULES = [
    {
        id: "LANG-PUNCT-001",
        category: "language",
...
function getCreativeRuleInventory() {
    const rules = exports.CREATIVE_EXECUTABLE_RULES.map(toInventoryItem);
...
function runCreativeRules(input) {
    return exports.CREATIVE_EXECUTABLE_RULES.flatMap((rule) => (ruleAppliesToTask(rule, input.taskType) ? rule.detect(input) : []));
}
