...
```typescript
import type { StylePackProfilesInner } from '@emptyinkpot/database-gateway-generated-client'
...
const example = {
  ...
  "tags": null,
  "searchScore": null,
} satisfies StylePackProfilesInner
...
const exampleParsed = JSON.parse(exampleJSON) as StylePackProfilesInner
